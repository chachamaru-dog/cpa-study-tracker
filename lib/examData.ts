...
export const SUBJECTS_SHORT: Subject[] = [
  {
    ...
    passingScore: 80,
    topics: [
      { id: "fin_revenue",       subjectId: "financial", name: "収益認識基準",                   weight: 5 },
      { id: "fin_financial_ins", subjectId: "financial", name: "金融商品",                       weight: 5 },
      { id: "fin_consolidation", subjectId: "financial", name: "連結財務諸表",                   weight: 5 },
      { id: "fin_merger",        subjectId: "financial", name: "企業結合・事業分離",             weight: 4 },
      { id: "fin_tangible",      subjectId: "financial", name: "有形固定資産・減価償却",         weight: 4 },
      { id: "fin_lease",         subjectId: "financial", name: "リース会計",                     weight: 4 },
      { id: "fin_impairment",    subjectId: "financial", name: "固定資産の減損",                 weight: 4 },
      { id: "fin_retirement",    subjectId: "financial", name: "退職給付会計",                   weight: 4 },
      { id: "fin_tax_effect",    subjectId: "financial", name: "税効果会計",                     weight: 4 },
      { id: "fin_cashflow",      subjectId: "financial", name: "キャッシュ・フロー計算書",       weight: 4 },
      { id: "fin_forex",         subjectId: "financial", name: "外貨換算会計",                   weight: 3 },
      { id: "fin_hedge",         subjectId: "financial", name: "デリバティブ・ヘッジ会計",       weight: 3 },
      { id: "fin_provision",     subjectId: "financial", name: "引当金・負債会計",               weight: 3 },
      { id: "fin_inventory",     subjectId: "financial", name: "棚卸資産",                       weight: 3 },
      { id: "fin_equity",        subjectId: "financial", name: "純資産・資本会計",               weight: 3 },
      { id: "fin_intangible",    subjectId: "financial", name: "無形固定資産・研究開発費",       weight: 3 },
      { id: "fin_asset_retire",  subjectId: "financial", name: "資産除去債務",                   weight: 3 },
      { id: "fin_segment",       subjectId: "financial", name: "セグメント情報・開示",           weight: 2 },
      { id: "fin_principles",    subjectId: "financial", name: "概念フレームワーク・会計基準の体系", weight: 5 },
      { id: "fin_th_ifrs",       subjectId: "financial", name: "IFRS・国際的動向",              weight: 3 },
      { id: "fin_th_policy",     subjectId: "financial", name: "会計方針・会計上の見積り変更",   weight: 3 },
    ],
  },
  {
    id: "management",
    ...
    topics: [
      ...
      { id: "mgmt_standard",    subjectId: "management", name: "標準原価計算・差異分析",        weight: 5 },
      { id: "mgmt_direct",      subjectId: "management", name: "直接原価計算・CVP分析",         weight: 4 },
      { id: "mgmt_decision",    subjectId: "management", name: "意思決定会計（短期）",          weight: 4 },
      { id: "mgmt_investment",  subjectId: "management", name: "設備投資の経済計算（長期）",    weight: 3 },
      { id: "mgmt_budget",      subjectId: "management", name: "予算管理・業績評価",            weight: 4 },
      { id: "mgmt_abc",         subjectId: "management", name: "活動基準原価計算（ABC）",       weight: 3 },
      { id: "mgmt_cvp",         subjectId: "management", name: "CVP分析・損益分岐点",           weight: 4 },
    ],
  },
  {
    id: "audit",
    ...
    passingScore: 40,
    topics: [
      { id: "audit_concept",    subjectId: "audit", name: "財務諸表監査の目的・基本概念",   weight: 4 },
      { id: "audit_risk",       subjectId: "audit", name: "リスク・アプローチ",             weight: 5 },
      { id: "audit_internal",   subjectId: "audit", name: "内部統制の評価",                 weight: 4 },
      { id: "audit_plan",       subjectId: "audit", name: "監査計画・重要性の基準値",       weight: 4 },
  ...
  },
  {
    ...
    passingScore: 40,
    topics: [
      { id: "corp_establish",   subjectId: "corporate", name: "設立・定款自治",               weight: 3 },
      { id: "corp_share",       subjectId: "corporate", name: "株式・社債・新株予約権",       weight: 4 },
      { id: "corp_meeting",     subjectId: "corporate", name: "株主総会・機関設計",           weight: 4 },
      { id: "corp_director",    subjectId: "corporate", name: "取締役・取締役の義務と責任",   weight: 5 },
      { id: "corp_calc",        subjectId: "corporate", name: "計算・剰余金の配当",           weight: 3 },
      { id: "corp_reorg",       subjectId: "corporate", name: "組織再編（合併・会社分割）",   weight: 5 },
...
export const SUBJECTS_ESSAY: Subject[] = [
  {
    ...
    topics: [
      { id: "fin_revenue",       subjectId: "financial", name: "収益認識基準",                   weight: 5 },
      { id: "fin_financial_ins", subjectId: "financial", name: "金融商品",                       weight: 4 },
      { id: "fin_consolidation", subjectId: "financial", name: "連結会計・企業結合",             weight: 5 },
      { id: "fin_lease",         subjectId: "financial", name: "リース会計",                     weight: 3 },
      { id: "fin_impairment",    subjectId: "financial", name: "固定資産・減損会計",             weight: 4 },
      { id: "fin_retirement",    subjectId: "financial", name: "退職給付会計",                   weight: 4 },
      { id: "fin_tax_effect",    subjectId: "financial", name: "税効果会計",                     weight: 4 },
      { id: "fin_forex",         subjectId: "financial", name: "外貨換算会計・デリバティブ",     weight: 3 },
      { id: "fin_cashflow",      subjectId: "financial", name: "キャッシュ・フロー計算書",       weight: 3 },
      { id: "fin_equity",        subjectId: "financial", name: "純資産会計",                     weight: 3 },
      { id: "fin_principles",    subjectId: "financial", name: "概念フレームワーク",             weight: 5 },
      { id: "fin_th_ifrs",       subjectId: "financial", name: "IFRS・国際的動向",              weight: 4 },
      { id: "fin_th_policy",     subjectId: "financial", name: "会計方針・会計上の見積り変更",   weight: 3 },
    ],
  },
  {
    ...
    passingScore: 0,
    topics: [
      { id: "mgmt_theory",      subjectId: "management", name: "原価計算基準・管理会計理論",    weight: 4 },
      { id: "mgmt_process",     subjectId: "management", name: "総合原価計算",                  weight: 4 },
      { id: "mgmt_standard",    subjectId: "management", name: "標準原価計算・差異分析",        weight: 5 },
      { id: "mgmt_direct",      subjectId: "management", name: "直接原価計算・CVP分析",         weight: 4 },
      { id: "mgmt_decision",    subjectId: "management", name: "意思決定会計（短期）",          weight: 4 },
      { id: "mgmt_investment",  subjectId: "management", name: "設備投資の経済計算（長期）",    weight: 4 },
      { id: "mgmt_budget",      subjectId: "management", name: "予算管理・業績評価・内部振替",  weight: 4 },
      { id: "mgmt_abc",         subjectId: "management", name: "戦略的管理会計（ABC・BSC）",   weight: 3 },
    ],
  },
  {
    id: "audit",
    ...
    topics: [
      { id: "audit_concept",    subjectId: "audit", name: "財務諸表監査の目的・基本概念",   weight: 4 },
      { id: "audit_risk",       subjectId: "audit", name: "リスク・アプローチと監査手続",   weight: 5 },
      { id: "audit_internal",   subjectId: "audit", name: "内部統制の評価（IT・J-SOX）",   weight: 4 },
      { id: "audit_evidence",   subjectId: "audit", name: "監査証拠・実証手続",             weight: 4 },
      { id: "audit_report",     subjectId: "audit", name: "監査報告書・除外事項",           weight: 4 },
      { id: "audit_ethics",     subjectId: "audit", name: "倫理規則・独立性",               weight: 4 },
      { id: "audit_quality",    subjectId: "audit", name: "品質管理",                       weight: 3 },
      { id: "audit_group",      subjectId: "audit", name: "グループ監査・特殊領域",         weight: 3 },
    ],
  },
  {
    id: "corporate",
    ...
    topics: [
      ...
      { id: "corp_reorg",       subjectId: "corporate", name: "組織再編（合併・会社分割）",   weight: 5 },
      { id: "corp_finlaw",      subjectId: "corporate", name: "金融商品取引法",               weight: 4 },
      { id: "corp_establish",   subjectId: "corporate", name: "設立・定款自治",               weight: 2 },
    ],
  },
  {
    id: "tax",
    ...
    passingScore: 0,
    topics: [
      { id: "tax_corporate",        subjectId: "tax", name: "法人税法（益金・損金の額）",         weight: 5 },
      { id: "tax_corporate_grp",    subjectId: "tax", name: "法人税法（グループ通算・特別控除）", weight: 4 },
      { id: "tax_income",           subjectId: "tax", name: "所得税法",                          weight: 3 },
      { id: "tax_consumption",      subjectId: "tax", name: "消費税法",                          weight: 4 },
      { id: "tax_theory",           subjectId: "tax", name: "租税法の基本原則・解釈",            weight: 3 },
    ],
  },
  {
    id: "elective",
    ...
    passingScore: 0,
    topics: [
      { id: "elect_strategy",  subjectId: "elective", name: "企業戦略（競争戦略・成長戦略）",   weight: 5 },
      { id: "elect_org",       subjectId: "elective", name: "組織論（組織構造・組織行動）",     weight: 4 },
      { id: "elect_finance",   subjectId: "elective", name: "コーポレートファイナンス",         weight: 5 },
      { id: "elect_ma",        subjectId: "elective", name: "M&A・企業価値評価",               weight: 4 },
      { id: "elect_marketing", subjectId: "elective", name: "マーケティング",                   weight: 3 },
    ],
  },
];
