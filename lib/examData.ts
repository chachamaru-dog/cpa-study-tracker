...
export const SUBJECTS_SHORT: Subject[] = [
  {
    ...
    topics: [
      ...
      { id: "fin_financial_ins", subjectId: "financial_calc", name: "金融商品",                   weight: 5 },
      ...
      { id: "fin_inventory",     subjectId: "financial_calc", name: "棚卸資産",                   weight: 3 },
  ...
  },
  {
    ...
    passingScore: 40,
    topics: [
      { id: "fin_principles",     subjectId: "financial_theory", name: "概念フレームワーク・会計基準の体系", weight: 5 },
      { id: "fin_th_recognition", subjectId: "financial_theory", name: "収益・費用の認識（理論）",         weight: 4 },
      { id: "fin_th_assets",      subjectId: "financial_theory", name: "資産・負債の評価（理論）",         weight: 4 },
      { id: "fin_th_display",     subjectId: "financial_theory", name: "財務諸表の表示・注記",             weight: 4 },
      { id: "fin_th_policy",      subjectId: "financial_theory", name: "会計方針の変更・会計上の見積り",   weight: 3 },
      { id: "fin_th_ifrs",        subjectId: "financial_theory", name: "IFRS・国際的動向",               weight: 3 },
      { id: "fin_th_disclosure",  subjectId: "financial_theory", name: "開示規制・四半期情報",            weight: 3 },
    ],
  },
  {
    id: "management",
  ...
  },
  {
    ...
    passingScore: 40,
    topics: [
      { id: "audit_concept",    subjectId: "audit", name: "監査の基礎概念・目的",         weight: 4 },
      ...
      { id: "audit_group",      subjectId: "audit", name: "グループ監査",                 weight: 2 },
    ],
  },
  {
    id: "corporate",
    ...
    topics: [
      ...
      { id: "corp_calc",        subjectId: "corporate", name: "計算・剰余金の配当",           weight: 4 },
      { id: "corp_reorg",       subjectId: "corporate", name: "組織再編（合併・会社分割）",   weight: 4 },
...
export const SUBJECTS_ESSAY: Subject[] = [
  ...SUBJECTS_SHORT.map((s) => ({ ...s, passingScore: 0 })),
  {
    ...
    passingScore: 0,
    topics: [
      { id: "tax_corporate",     subjectId: "tax", name: "法人税法（益金・損金）",             weight: 5 },
      ...
      { id: "tax_theory",        subjectId: "tax", name: "租税法の基本原則",                  weight: 3 },
    ],
  },
  {
    id: "elective",
    ...
    topics: [
      ...
      { id: "elect_org",       subjectId: "elective", name: "組織論",                         weight: 4 },
